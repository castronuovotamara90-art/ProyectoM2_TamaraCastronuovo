...
const shouldPreferInternalRailwayConfig =
  envs.NODE_ENV === 'production' &&
  hasDiscreteConfig &&
  typeof envs.DB_HOST === 'string' &&
  envs.DB_HOST.endsWith('.railway.internal');

const useDatabaseUrl = hasDatabaseUrl && !shouldPreferInternalRailwayConfig;

const dbConnectionProduction = useDatabaseUrl
  ? withOptionalSsl({
...
if (envs.NODE_ENV === 'production' && !useDatabaseUrl && !hasDiscreteConfig) {
